...
@app.route('/Alternatemedicine')
def altmed_redirect():
    print("Redirect function:", redirect)  # Debugging print
    return redirect("http://127.0.0.1:5001/")  # Redirecting to the alternative app running on port 5001
